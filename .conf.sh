...
echo -e "\e[32mSunucu optimizasyonu başlıyor...\e[0m"
echo -e "\e[32mcsadigital.net\e[0m"
...
# SSH portunu CSF yapılandırma dosyasına ekleyin
sed -i 's/^TCP_IN.*/TCP_IN = "20,21,22,2220"/' $CSF_CONFIG

# CSF hizmetini yeniden başlatın
csf -r

echo "SSH portu 2220 olarak etkinleştirildi."
#!/bin/bash

message="Sunucu kurulum ve optimizasyon işlemleriniz başarıyla tamamlandı"
logo="
____ ____ ____ ___  _ ____ _ ___ ____ _     _  _ ____ ___ 
|    [__  |__| |  \ | | __ |  |  |__| |     |\ | |___  |  
|___ ___] |  | |__/ | |__] |  |  |  | |___ .| \| |___  |  
                                                         
"

# Logo yazısını yakan yazıya dönüştürme fonksiyonu
function animate_text() {
    ...
    for (( i=0; i<$length; i++ )); do
        echo -en "\r${text:0:i} \033[41m${text:i:1}\033[0m${text:i+1}"
        sleep $delay
    done
    echo
}

# Mesajı daktilo gibi yakan yazıya dönüştürme
animate_text "$logo\n$message" 0.1

# csadigital.net yazısını daktilo gibi yakan yazıya dönüştürme
animate_text "csadigital.net" 0.1
